...
public class Percolation {
    private int n;
    private static int size, first, last;
    private static WeightedQuickUnionUF weightedUnion;
    ...
    public void open(int i, int j) {
        ...
        // attempt to connect bottom & top site (i.e., above and below current site)
        int bottom = id + n;
        int top = id - n;
        ...
        // if col is 1, means left column; attempt to connect right and 
        // bottom site
        if (j == 1) {
            // to right
            int right = id + 1;
